        ...
        <div className={styles.AboutArticles}>
          ...
          <div className={styles.AboutArticle}>
            <div className={styles.ArticleInfo}>
              ...
              <p className={styles.Content}>
                A &apos;Cruce Salus&apos; (safety of the cross) is our watchword
                and will continue to be our guide.
              </p>
              <p className={styles.Content}>
                We shall point the way to the Cross of Christ; the source of our
                Salvation.
              </p>
              <p className={styles.Content}>
                We shall through lip and life endeavour to proclaim our Risen
                Lord Jesus to every land and clime through the spread of the
                Good News.
              </p>
              <p className={styles.Content}>
              ...
              <p className={styles.Content}>
                We shall motivate and inspire all to fulfill their God-given
                potentials.
              </p>
              <p className={styles.Content}>
                We shall seek to lead people to our ultimate goal, i. e. to make
                heaven as they seek things that are above and not below.
              </p>
            </div>
            <div className={styles.Image}>
              <Image
          ...
          <div className={styles.AboutArticle}>
            <div className={styles.ArticleInfo}>
              <h2 className={styles.ContentHeading}>Our Anthem</h2>
              <p className={styles.content}>DIOCESAN ANTHEM</p>
              <p className={styles.Content}>
                1. A Cruce Salus; Agbelebu <br />
                Kristi fun ‘gbala wa <br />
                Wa lori asia wa <br />
                Ni Ondo Daosis’ <br />
                Ni Odun 1952 <br />
                L’Oluwa da sile <br />
                Gegebi Ondo-Benin <br />
                Anglikan ‘Daosis
              </p>
              <p className={styles.Content}>
                2. Ise wa ni lati kede
                <br />
                Jesu Olugbala
                <br />
                ...
                Ihin igbala wa
                <br />
                E ho f’ayo k’inu wa dun
                <br />
                Igbala wa ti de
                <br />
                Sun mo ju ’gba t’a ko gbagbo
                <br />E ho Halleluyah!
              </p>
            </div>
            <div className={styles.Image}>
